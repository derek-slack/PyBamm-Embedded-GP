...
#
# class GradientPoolManager:
#     """
#     Truly singleton process pool manager to create the pool only once
#     """
#     _instance = None
#     _pool = None
#
...
#             cls._instance = super(GradientPoolManager, cls).__new__(cls)
#
#             # Create pool only if it doesn't exist
#             if cls._pool is None:
#                 if num_workers is None:
#                     num_workers = multiprocessing.cpu_count() - 2
#                 cls._pool = ProcessPool(nodes=num_workers)
#
...
#     def get_pool(cls):
#         """
#         Retrieve the singleton pool instance
#         """
#         if cls._pool is None:
#             cls()  # Ensure pool is created
#         return cls._pool
#
#     @classmethod
#     def close_pool(cls):
...
class Embedded_GP_Model:
    ...
    def neg_log_likelihood(self, betas, d=True):
        """
    ...
    def d_neg_log_likelihood_create(self):
        ...
        #
        #     pool = GradientPoolManager.get_pool()
        #
